<h1 align="center">🤝 Contributing to Questorr</h1>

<p align="center">
  Thank you for considering contributing to Questorr! We appreciate all kinds of contributions, from bug reports to new features.
</p>
...
[Open a bug report](https://github.com/openVESSL/Questorr/issues/new?labels=bug&template=bug_report.md)

### 💡 Suggest Features

Have an idea to improve Questorr?
...
[Suggest a feature](https://github.com/openVESSL/Questorr/issues/new?labels=enhancement&template=feature_request.md)
...
Questorr supports multiple languages! Help make it accessible to more users by contributing translations. The translation system is fully automated!
...
1. Start the Questorr server: `node app.js`
...
4. Push and [open a Pull Request](https://github.com/openVESSL/Questorr/compare) against the `main` branch
...
git clone https://github.com/YOUR-USERNAME/questorr.git
cd questorr
npm install
```
...
Then [open a PR](https://github.com/openVESSL/Questorr/compare) against the `main` branch.
