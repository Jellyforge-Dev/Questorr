export const configTemplate = {
  ...
  STREAMYSTATS_URL: "",
  // Jellyfin credentials used to authenticate against Streamystats.
  // Streamystats validates requests via Jellyfin session tokens; a static API key
  // is not accepted. Use the same credentials you log into Streamystats with.
  STREAMYSTATS_USER: "",
  STREAMYSTATS_PASS: "",
